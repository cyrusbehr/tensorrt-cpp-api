...
inline void showHelp(char* argv[]) {
    ...
    std::cout << "--onnx_model <string>             Path to the ONNX model. (Either onnx_model or trt_model must be provided)" << std::endl;
    std::cout << "--trt_model <string>              Path to the TensorRT model. (Either onnx_model or trt_model must be provided)" << std::endl;
